...
const STORAGE_KEY = "clause_auth_toast_dismissed";
  ...
  return (
    <>
      <div
        role="dialog"
        aria-live="polite"
        aria-label="Açık beta kayıt hatırlatması"
        className={cn(
      ...
      >
        <div className="relative rounded-2xl border border-indigo-900/60 bg-indigo-950/90 p-4 text-white shadow-2xl backdrop-blur-md">
          ...
          <p className="mt-3 pr-6 text-sm font-bold tracking-tight">
            Sözleşme &amp; Dilekçe Araçları Açık
          </p>
          <p className="mt-1.5 text-[13px] font-medium leading-relaxed text-indigo-100/90">
            Yapay zeka ile risk taraması ve otomatik dilekçe oluşturucu lansman
            boyunca tamamen ücretsizdir.
          </p>
