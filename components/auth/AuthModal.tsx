...
import { LAUNCH_AUTH_COPY } from "@/lib/launch";
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md rounded-2xl">
        ...
        <Button
          type="button"
          className="h-12 w-full rounded-xl bg-indigo-600 font-semibold hover:bg-indigo-700"
          disabled={busy}
